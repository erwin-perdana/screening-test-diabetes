<div class="flex relative">
    ...
    <aside id="sidebar" class="bg-blue-300 text-white w-64 min-h-screen p-6 flex flex-col items-center lg:flex">
        ...
        <ul class="mt-10">
            <li class="mb-2">
                <a href="{{route('user.dashboard')}}" class="text-sky-900 sidebar-link block hover:bg-blue-700 rounded px-3 py-2">
                    <i class="fas fa-tachometer-alt mr-2"></i> Mulai Tes
                </a>
            </li>
            <li class="mb-2">
                <a href="{{route('user.result_risk')}}" class="text-sky-900 sidebar-link block hover:bg-blue-700 rounded px-3 py-2">
                    <i class="fas fa-users mr-2"></i> Hasil Resiko Diabetes
                </a>
            </li>
            <li class="mb-2">
                <a href="{{route('user.profile')}}" class="text-sky-900 sidebar-link block hover:bg-blue-700 rounded px-3 py-2">
                    <i class="fas fa-users mr-2"></i> Kelola Profil
                </a>
            </li>
        </ul>
    </aside>
    ...
    <main class="w-full">
        <div class="py-2 px-6 bg-white flex items-center shadow-md shadow-black/5 sticky top-0 left-0 z-30">
            ...
            <a href="{{route('user.dashboard')}}" class="text-l ml-8 font-semibold tracking-widest no-underline">
                <span class="text-black">@yield('title', 'Diabe Test')</span>
            </a>
